...
% CJK font for "张天乐": Noto on GitHub Actions (texlive full image); Droid on Windows.
...
(AAAI 2026) and on understanding modality interaction in multimodal LLMs via partial information
decomposition (ICML 2026). On the evaluation side, I re-designed the human-evaluation protocol for
text-to-video generation (NeurIPS 2024, first author), and contributed to ConvBench, a hierarchical
multi-turn benchmark for large vision-language models (NeurIPS 2024 Spotlight). Earlier work on
efficient learning includes expanding-window trajectory matching for lossless graph dataset
condensation (ICML 2024, co-first author). Across 9 publications at top-tier ML venues (NeurIPS,
ICML, AAAI) and IEEE conferences, I am first or co-first author on 5. I am supported by the NTU
Research Scholarship, and serve as a reviewer for ICLR 2026/2027, NeurIPS 2025/2026, ICML 2025/2026, AAAI 2027, and TMLR.
...
\begin{itemize}[leftmargin=1.4em, itemsep=4pt]
  ...
  \item \textbf{(Under review, ICLR'27)}~Do What You Say: Towards Verifiable Reasoning for Scientific Editing.\par
        \me{Tianle Zhang}, Wanlong Fang, Jiaqi Zhu, Wen Tao, Ying-Peng Tang, Alvin Chan\corr.\par
        \textit{Under review at the 15th International Conference on Learning Representations, 2027.}

  \item \textbf{(ICML'26)}~Towards Understanding Modality Interaction in Multimodal Language Models via Partial Information Decomposition.\par
        Wanlong Fang, \me{Tianle Zhang}, Wen Tao, Alvin Chan\corr.\par
        \textit{Proceedings of the 43rd International Conference on Machine Learning, 2026.}
...
\begin{itemize}
  \item International Conference on Learning Representations (ICLR): 2026, 2027
  ...
  \item AAAI Conference on Artificial Intelligence (AAAI): 2027
  \item Transactions on Machine Learning Research (TMLR): 2026
...
\textbf{Tools:} Git, Linux, CUDA, LaTeX, Weights \& Biases; AI coding agents (Claude Code, Codex).\par
